...
class H2Upload
{
    ...
    function __construct($options=null) {
        $this->options = array(
            'script_url' => '/post/upload',
            'upload_dir' => 'static/temp/'.$_SESSION['uid'].'/',
            'upload_url' => '/static/temp/'.$_SESSION['uid'].'/',
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    'upload_dir' => 'static/temp/'.$_SESSION['uid'].'/tn/',
                    'upload_url' => '/static/temp/'.$_SESSION['uid'].'/tn/',
                    'max_width' => 120,
                    'max_height' => 80
                )
            )
        );
        $dirname = 'static/temp/'.$_SESSION['uid'].'/tn';
